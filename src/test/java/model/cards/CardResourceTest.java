...
class CardResourceTest {
    ...
    Face frontTmp = new Face(new Corner(SuitEnum.ANIMAL), new Corner(SuitEnum.ANIMAL), new Corner(SuitEnum.FUNGI), new Corner(SuitEnum.FUNGI));
    ...
    @Test
    void countResource() {
        assertEquals(2, cardAnimal1.countResource(SuitEnum.ANIMAL));
        assertEquals(2, cardAnimal1.countResource(SuitEnum.FUNGI));
        assertEquals(0, cardAnimal1.countResource(SuitEnum.PLANT));
        cardAnimal1.setPlayingBack(true);
