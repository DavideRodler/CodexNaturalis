...
public class CardMatrixCreator {
    ...
    public static String[][] createFrontSmallPlayingCard(CardResource card){
        String[][] smallResCard = new String[2][3];
        int rows = smallResCard.length;
        int cols = smallResCard[0].length;
        String color = colorResource(card);
        for(int i = 0; i < rows; i++){
            for(int j = 0; j < cols; j++){
                smallResCard[i][j] = color + "█";
            }
        }
        for(int i = 0; i < rows; i++){
            for(int j = 0; j < cols; j++){
...
//                    smallResCard[i][j-1] = " ";
    ...
    public static String[][] createFrontSmallPlayingCard(CardGold card){
        String[][] goldCard = createFrontSmallPlayingCard((CardResource) card);
        hasPoints(card, goldCard);
        hasCost(card, goldCard);
        return goldCard;
    }

    public static String[][] createFrontSmallPlayingCard(CardStarting card) {
        String[][] startingCard = new String[2][3];
...
//                    startingCard[i][j-1] = " ";
        ...
        //setto le risorse in mezzo alla carta. facendole piccole non ci interessano
    ...
    public static String[][] createBackSmallPlayingCard(CardResource card){
        String[][] resCard = new String[2][3];
        int rows = resCard.length;
        int cols = resCard[0].length;
        String color = colorResource(card);
        for(int i = 0; i < rows; i++){
...
//                    resCard[i][j-1] = " ";
    ...
    public static String[][] creteBackSmallPlayingCard(CardStarting card){
        String[][] startingCard = new String[2][3];
        int rows = startingCard.length;
        int cols = startingCard[0].length;
        for(int i = 0; i < rows; i++){
