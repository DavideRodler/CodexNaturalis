...
//        Face backTmp = new Face(SuitEnum.EMPTY, SuitEnum.EMPTY, SuitEnum.EMPTY, SuitEnum.EMPTY);
//
//        Face frontTmp = new Face(SuitEnum.ANIMAL, SuitEnum.NULL, SuitEnum.EMPTY, SuitEnum.FUNGI);
//
//        Face frontTmp2 = new Face(SuitEnum.ANIMAL, SuitEnum.ANIMAL, SuitEnum.EMPTY, SuitEnum.FUNGI);
//        Objective obj = new ObjectiveAssign();
//        // the card resource is of type ANIMAL
...
//
//        Face front = new Face(SuitEnum.ANIMAL, SuitEnum.EMPTY, SuitEnum.EMPTY, SuitEnum.FUNGI);
//
//        Face frontGold = new Face(SuitEnum.INKWELL, SuitEnum.EMPTY, SuitEnum.EMPTY, SuitEnum.EMPTY);
//
